...
void Shader::SetTex(const std::string& name, const GLuint tex) const
{
...
void Shader::SetFloat(const std::string& name, const GLfloat flt) const
{
    glUniform1f(glGetUniformLocation(id, name.c_str()), flt);
}